...
├── demo.template.sql       # seed template with relative-date placeholders ({{D+n}}, {{EOM-n}}, ...)
├── demo.sql                # generated from the template by scripts/gen-demo.js (dates relative to today)
└── wrangler.toml           # generated by scripts/setup.sh
```
